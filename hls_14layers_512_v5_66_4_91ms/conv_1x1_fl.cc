					  ...
					  FIX_WT w15, FIX_FM b15)
{
	...
	mul8  = w8  * (FIX_16_3)b8;
	mul9  = w9  * (FIX_16_3)b9;
	mul10 = w10 * (FIX_16_3)b10;
	mul11 = w11 * (FIX_16_3)b11;
	mul12 = w12 * (FIX_16_3)b12;
	mul13 = w13 * (FIX_16_3)b13;
	mul14 = w14 * (FIX_16_3)b14;
	mul15 = w15 * (FIX_16_3)b15;
...
void CONV_1x1_16(FIX_FM (*bottom)[22][42],
			  FIX_FM (*top)[22][42],
...
#pragma HLS array_partition variable=tmp dim=1 complete
	...
	#pragma HLS unroll
					tmp[co] = compute_engine_16(
											 weight_buf[co][0],   bottom[0][h][w],
											 weight_buf[co][1],   bottom[1][h][w],
											 weight_buf[co][2],   bottom[2][h][w],
											 weight_buf[co][3],   bottom[3][h][w],
											 weight_buf[co][4],   bottom[4][h][w],
											 weight_buf[co][5],   bottom[5][h][w],
											 weight_buf[co][6],   bottom[6][h][w],
											 weight_buf[co][7],   bottom[7][h][w],
											 weight_buf[co][8],   bottom[8][h][w],
											 weight_buf[co][9],   bottom[9][h][w],
											 weight_buf[co][10],  bottom[10][h][w],
											 weight_buf[co][11],  bottom[11][h][w],
											 weight_buf[co][12],  bottom[12][h][w],
											 weight_buf[co][13],  bottom[13][h][w],
											 weight_buf[co][14],  bottom[14][h][w],
											 weight_buf[co][15],  bottom[15][h][w]);
				}
	...
	#pragma HLS unroll
						tmp[co] = compute_engine_16(
												 weight_buf[co][0 + 16],   bottom[0 + 16][h][w],
												 weight_buf[co][1 + 16],   bottom[1 + 16][h][w],
												 weight_buf[co][2 + 16],   bottom[2 + 16][h][w],
												 weight_buf[co][3 + 16],   bottom[3 + 16][h][w],
												 weight_buf[co][4 + 16],   bottom[4 + 16][h][w],
												 weight_buf[co][5 + 16],   bottom[5 + 16][h][w],
												 weight_buf[co][6 + 16],   bottom[6 + 16][h][w],
												 weight_buf[co][7 + 16],   bottom[7 + 16][h][w],
												 weight_buf[co][8 + 16],   bottom[8 + 16][h][w],
												 weight_buf[co][9 + 16],   bottom[9 + 16][h][w],
												 weight_buf[co][10 + 16],  bottom[10 + 16][h][w],
												 weight_buf[co][11 + 16],  bottom[11 + 16][h][w],
												 weight_buf[co][12 + 16],  bottom[12 + 16][h][w],
												 weight_buf[co][13 + 16],  bottom[13 + 16][h][w],
												 weight_buf[co][14 + 16],  bottom[14 + 16][h][w],
												 weight_buf[co][15 + 16],  bottom[15 + 16][h][w]);
					}
