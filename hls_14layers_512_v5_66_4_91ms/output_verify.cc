...
extern float conv_12_bias_in[348];

extern float conv_13_weight_in[512][384];
extern float conv_13_weight_reoroder[768][16][16];
extern float conv_13_bias_in[512];


extern float conv_14_weight_tmp[10][512];
extern float conv_14_weight_in[16][512];
extern float conv_14_weight_reorder[32][16][16];


float conv_1_out_PL[l1_cd * BUF_DPTH][160][320];
float conv_2_out_PL[l2_cd * BUF_DPTH][160][320];
float pool_3_out_PL[l3_cd * BUF_DPTH][80][160];
float conv_4_out_PL[l4_cd * BUF_DPTH][80][160];
float conv_5_out_PL[l5_cd * BUF_DPTH][80][160];
float pool_6_out_PL[l6_cd * BUF_DPTH][40][80];
float conv_7_out_PL[l7_cd * BUF_DPTH][40][80];
float conv_8_out_PL[l8_cd * BUF_DPTH][40][80];
float pool_9_out_PL[l9_cd * BUF_DPTH][20][40];
float conv_10_out_PL[l10_cd * BUF_DPTH][20][40];
float conv_11_out_PL[l11_cd * BUF_DPTH][20][40];
float conv_12_out_PL[l12_cd * BUF_DPTH][20][40];
float conv_13_out_PL[l13_cd * BUF_DPTH][20][40];
float conv_14_out_PL[l14_cd * BUF_DPTH][20][40];
...
float conv_12_out[384][20][40];
float conv_13_out[512][20][40];
float conv_14_out[10][20][40];
            ...
            )
{
    ...
    fo = fopen("conv_14_out", "w");
    for(int i = 0; i < 10; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "conv_14_output[%d][%d][%d] = %f\n", i, j, k, output[i][j][k]);
            }
        }
    }
    fclose(fo);
...
void golden_model()
{
	...
	conv_12(conv_11_out, conv_12_weight_in, conv_12_bias_in, conv_12_out);
	conv_13(conv_12_out, conv_13_weight_in, conv_13_bias_in, conv_13_out);
	conv_14(conv_13_out, conv_14_weight_tmp, conv_14_out);

	compute_bounding_box(conv_14_out);
	...
	for(int i = 0; i < BUF_DPTH; i++) {
		for(int j = 1; j <= 20; j++) {
			for(int k = 1; k <= 40; k++) {
				...
				{
				case 1:
					conv_1_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 2:
					conv_2_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 4:
					conv_4_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 5:
					conv_5_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 7:
					conv_7_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 8:
					conv_8_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 10:
					conv_10_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 11:
					conv_11_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 12:
					conv_12_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 13:
					conv_13_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				case 14:
					conv_14_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k];
					break;
				default:
	...
	for(int i = 0; i < BUF_DPTH; i++) {
		for(int j = 0; j < 10; j++) {
			for(int k = 0; k < 20; k++) {
				...
				{
				case 3:
					pool_3_out_PL[i + ch*BUF_DPTH][j + col*10][k + row*20] = buf[i][j][k];
					break;
				case 6:
					pool_6_out_PL[i + ch*BUF_DPTH][j + col*10][k + row*20] = buf[i][j][k];
					break;
				case 9:
					pool_9_out_PL[i + ch*BUF_DPTH][j + col*10][k + row*20] = buf[i][j][k];
					break;
				default:
					printf("Wrong layer number.\n");
				}
	...
	for(int i = 0; i < BUF_DPTH; i++) {
		for(int j = 1; j <= 20; j++) {
			for(int k = 1; k <= 40; k++) {
				...
				{
				case 1:
					conv_1_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 2:
					conv_2_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 4:
					conv_4_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 5:
					conv_5_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 7:
					conv_7_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 8:
					conv_8_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 10:
					conv_10_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 11:
					conv_11_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 12:
					conv_12_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 13:
					conv_13_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				case 14:
					conv_14_out_PL[ch*BUF_DPTH+i][col*20+j-1][row*40+k-1] = buf[i][j][k].to_float();
					break;
				}
	...
	for(int i = 0; i < BUF_DPTH; i++) {
		for(int j = 0; j < 10; j++) {
			for(int k = 0; k < 20; k++) {
				...
				{
				case 3:
					pool_3_out_PL[i + ch*BUF_DPTH][j + col*10][k + row*20] = buf[i][j][k].to_float();
					break;
				case 6:
					pool_6_out_PL[i + ch*BUF_DPTH][j + col*10][k + row*20] = buf[i][j][k].to_float();
					break;
				case 9:
					pool_9_out_PL[i + ch*BUF_DPTH][j + col*10][k + row*20] = buf[i][j][k].to_float();
					break;
				default:
					printf("Wrong layer number.\n");
				}
	...
	for(int ch = 0; ch < 48; ch++) {
			for(int w = 0; w < 160; w++) {
				for(int h = 0; h < 80; h++) {
					...
					//printf("pool_3_out_PL[%d][%d][%d]: %f; pool_3_out[%d][%d][%d]: %f\n",
					//		ch, w, h, pool_3_out_PL[ch][h][w], ch, w, h, pool_3_out[ch][h][w]);
...
int PL_golden_compare_layer_14()
{
	...
	char filename[32];
	sprintf(filename, "Comp_layer_14");
	...
	for(int ch = 0; ch < 10; ch++) {
			for(int w = 0; w < 40; w++) {
				for(int h = 0; h < 20; h++) {
				if( abs(conv_14_out_PL[ch][h][w] - conv_14_out[ch][h][w]) < EPSILON ) {
					fprintf(fo, ".");
				}
				else {
					fprintf(fo, "X");
...
void output_PL_layers()
{
    ...
    fo = fopen("conv_1_out_fix", "w");
    for(int i = 0; i < 3; i++) {
        for(int j = 0; j < 160; j++) {
            for(int k = 0; k < 320; k ++) {
                fprintf(fo, "conv_1_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_1_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_2_out_fix", "w");
    for(int i = 0; i < 48; i++) {
        for(int j = 0; j < 160; j++) {
            for(int k = 0; k < 320; k ++) {
                fprintf(fo, "conv_2_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_2_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("pool_3_out_fix", "w");
    for(int i = 0; i < 48; i++) {
        for(int j = 0; j < 80; j++) {
            for(int k = 0; k < 160; k ++) {
                fprintf(fo, "conv_3_output_fix[%d][%d][%d] = %f\n", i, j, k, pool_3_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_4_out_fix", "w");
    for(int i = 0; i < 48; i++) {
        for(int j = 0; j < 80; j++) {
            for(int k = 0; k < 160; k ++) {
                fprintf(fo, "conv_4_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_4_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_5_out_fix", "w");
    for(int i = 0; i < 96; i++) {
        for(int j = 0; j < 80; j++) {
            for(int k = 0; k < 160; k ++) {
                fprintf(fo, "conv_5_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_5_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("pool_6_out_fix", "w");
    for(int i = 0; i < 96; i++) {
        for(int j = 0; j < 40; j++) {
            for(int k = 0; k < 80; k ++) {
                fprintf(fo, "pool_6_output_fix[%d][%d][%d] = %f\n", i, j, k, pool_6_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_7_out_fix", "w");
    for(int i = 0; i < 96; i++) {
        for(int j = 0; j < 40; j++) {
            for(int k = 0; k < 80; k ++) {
                fprintf(fo, "conv_7_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_7_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_8_out_fix", "w");
    for(int i = 0; i < 192; i++) {
        for(int j = 0; j < 40; j++) {
            for(int k = 0; k < 80; k ++) {
                fprintf(fo, "conv_8_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_8_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("pool_9_out_fix", "w");
    for(int i = 0; i < 192; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "pool_9_output_fix[%d][%d][%d] = %f\n", i, j, k, pool_9_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_10_out_fix", "w");
    for(int i = 0; i < 192; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "conv_10_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_10_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_11_out_fix", "w");
    for(int i = 0; i < 384; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "conv_11_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_11_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_12_out_fix", "w");
    for(int i = 0; i < 384; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "conv_12_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_12_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_13_out_fix", "w");
    for(int i = 0; i < 512; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "conv_13_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_13_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
    ...
    fo = fopen("conv_14_out_fix", "w");
    for(int i = 0; i < 10; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
                fprintf(fo, "conv_14_output_fix[%d][%d][%d] = %f\n", i, j, k, conv_14_out_PL[i][j][k]);
            }
        }
    }
    fclose(fo);
...
void compare_PL_float()
{
    ...
    for(int i = 0; i < 3; i++) {
        for(int j = 0; j < 160; j++) {
            for(int k = 0; k < 320; k ++) {
            	if( abs(conv_1_out_PL[i][j][k] - conv_1_out[i][j][k]) > conv1 ) {
            		conv1 = abs(conv_1_out_PL[i][j][k] - conv_1_out[i][j][k]);
            		i1 = i; j1 = j; k1 = k;
            	}
            }
        }
    }
    printf("Conv1 max diff: %f [%d][%d][%d]\n", conv1, i1, j1, k1);
    ...
    for(int i = 0; i < 48; i++) {
        for(int j = 0; j < 160; j++) {
            for(int k = 0; k < 320; k ++) {
            	if( abs(conv_2_out_PL[i][j][k] - conv_2_out[i][j][k]) > conv2 ) {
					conv2 = abs(conv_2_out_PL[i][j][k] - conv_2_out[i][j][k]);
					i2 = i; j2 = j; k2 = k;
				}
            }
        }
    }
    printf("Conv2 max diff: %f [%d][%d][%d]\n", conv2, i2, j2, k2);
    ...
    for(int i = 0; i < 48; i++) {
        for(int j = 0; j < 80; j++) {
            for(int k = 0; k < 160; k ++) {
            	if( abs(pool_3_out_PL[i][j][k] - pool_3_out[i][j][k]) > conv3 ) {
					conv3 = abs(pool_3_out_PL[i][j][k] - pool_3_out[i][j][k]);
					i3 = i; j3 = j; k3 = k;
				}
            }
        }
    }
    printf("Conv3 max diff: %f [%d][%d][%d]\n", conv3, i3, j3, k3);
    ...
    for(int i = 0; i < 48; i++) {
        for(int j = 0; j < 80; j++) {
            for(int k = 0; k < 160; k ++) {
            	if( abs(conv_4_out_PL[i][j][k] - conv_4_out[i][j][k]) > conv4 ) {
					conv4 = abs(conv_4_out_PL[i][j][k] - conv_4_out[i][j][k]);
					i4 = i; j4 = j; k4 = k;
				}
            }
        }
    }
    printf("Conv4 max diff: %f [%d][%d][%d]\n", conv4, i4, j4, k4);
    ...
    for(int i = 0; i < 96; i++) {
        for(int j = 0; j < 80; j++) {
            for(int k = 0; k < 160; k ++) {
            	if( abs(conv_5_out_PL[i][j][k] - conv_5_out[i][j][k]) > conv5 ) {
					conv5 = abs(conv_5_out_PL[i][j][k] - conv_5_out[i][j][k]);
					i5 = i; j5 = j; k5 = k;
				}
            }
        }
    }
    printf("Conv5 max diff: %f [%d][%d][%d]\n", conv5, i5, j5, k5);
    ...
    for(int i = 0; i < 96; i++) {
        for(int j = 0; j < 40; j++) {
            for(int k = 0; k < 80; k ++) {
            	if( abs(pool_6_out_PL[i][j][k] - pool_6_out[i][j][k]) > conv6 ) {
					conv6 = abs(pool_6_out_PL[i][j][k] - pool_6_out[i][j][k]);
					i6 = i; j6 = j; k6 = k;
				}
            }
        }
    }
    printf("Conv6 max diff: %f [%d][%d][%d]\n", conv6, i6, j6, k6);
    ...
    for(int i = 0; i < 96; i++) {
        for(int j = 0; j < 40; j++) {
            for(int k = 0; k < 80; k ++) {
				if( abs(conv_7_out_PL[i][j][k] - conv_7_out[i][j][k]) > conv7 ) {
					conv7 = abs(conv_7_out_PL[i][j][k] - conv_7_out[i][j][k]);
					i7 = i; j7 = j; k7 = k;
				}
            }
        }
    }
    printf("Conv7 max diff: %f [%d][%d][%d]\n", conv7, i7, j7, k7);
    ...
    for(int i = 0; i < 192; i++) {
        for(int j = 0; j < 40; j++) {
            for(int k = 0; k < 80; k ++) {
				if( abs(conv_8_out_PL[i][j][k] - conv_8_out[i][j][k]) > conv8 ) {
					conv8 = abs(conv_8_out_PL[i][j][k] - conv_8_out[i][j][k]);
					i8 = i; j8 = j; k8 = k;
				}
            }
        }
    }
    printf("Conv8 max diff: %f [%d][%d][%d]\n", conv8, i8, j8, k8);
    ...
    for(int i = 0; i < 192; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
				if( abs(pool_9_out_PL[i][j][k] - pool_9_out[i][j][k]) > conv9 ) {
					conv9 = abs(pool_9_out_PL[i][j][k] - pool_9_out[i][j][k]);
					i9 = i; j9 = j; k9 = k;
				}
            }
        }
    }
    printf("Conv9 max diff: %f [%d][%d][%d]\n", conv9, i9, j9, k9);
    ...
    for(int i = 0; i < 192; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
				if( abs(conv_10_out_PL[i][j][k] - conv_10_out[i][j][k]) > conv10 ) {
					conv10 = abs(conv_10_out_PL[i][j][k] - conv_10_out[i][j][k]);
					i10 = i; j10 = j; k10 = k;
				}
            }
        }
    }
    printf("Conv10 max diff: %f [%d][%d][%d]\n", conv10, i10, j10, k10);
    ...
    for(int i = 0; i < 384; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
				if( abs(conv_11_out_PL[i][j][k] - conv_11_out[i][j][k]) > conv11 ) {
					conv11 = abs(conv_11_out_PL[i][j][k] - conv_11_out[i][j][k]);
					i11 = i; j11 = j; k11 = k;
				}
            }
        }
    }
    printf("Conv11 max diff: %f [%d][%d][%d]\n", conv11, i11, j11, k11);
    ...
    for(int i = 0; i < 384; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
				if( abs(conv_12_out_PL[i][j][k] - conv_12_out[i][j][k]) > conv12 ) {
					conv12 = abs(conv_12_out_PL[i][j][k] - conv_12_out[i][j][k]);
					i12 = i; j12 = j; k12 = k;
				}
            }
        }
    }
    printf("Conv12 max diff: %f [%d][%d][%d]\n", conv12, i12, j12, k12);
    ...
    for(int i = 0; i < 512; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
				if( abs(conv_13_out_PL[i][j][k] - conv_13_out[i][j][k]) > conv13 ) {
					conv13 = abs(conv_13_out_PL[i][j][k] - conv_13_out[i][j][k]);
					i13 = i; j13 = j; k13 = k;
				}
            }
        }
    }
    printf("Conv13 max diff: %f [%d][%d][%d]\n", conv13, i13, j13, k13);
    ...
    for(int i = 0; i < 10; i++) {
        for(int j = 0; j < 20; j++) {
            for(int k = 0; k < 40; k ++) {
				if( abs(conv_14_out_PL[i][j][k] - conv_14_out[i][j][k]) > conv14 ) {
					conv14 = abs(conv_14_out_PL[i][j][k] - conv_14_out[i][j][k]);
					i14 = i; j14 = j; k14 = k;
				}
            }
        }
    }
    printf("Conv14 max diff: %f [%d][%d][%d]\n", conv14, i14, j14, k14);
