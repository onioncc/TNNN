...
extern FIX_WT fix_conv_weight_3x3_all[46][BUF_DPTH][3][3];
extern FIX_WT fix_bias_all[123][BUF_DPTH];


FIX_FM DDR_pool_out_PL[96][82][162];	/// DDR Storage for pooling layers' output
FIX_FM DDR_pool3_out_PL[l3_cd * BUF_DPTH][82][162];	/// DDR Storage for pooling layers' output
FIX_FM DDR_pool6_out_PL[l6_cd * BUF_DPTH][42][82];	/// DDR Storage for pooling layers' output
...
{
    std::ifstream ifs_param("params_512_v1.bin", std::ios::in | std::ios::binary);
